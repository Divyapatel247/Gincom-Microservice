...
export class PushNotificationService {
  ...
  registerToken(userId: string, token: string): void {
    ...
    console.log('Sending token to:', `http://localhost:5003/api/notifications/register`);
    this.http.post('http://localhost:5003/api/notifications/register', { userId, token }).subscribe({
